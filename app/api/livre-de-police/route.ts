...
function mapRow(r: Record<string, unknown>): LivreDePolice {
  return {
    ...
    photoFace: r.photo_face != null ? String(r.photo_face) : null,
    photoDos: r.photo_dos != null ? String(r.photo_dos) : null,
    photoCoteGauche: r.photo_cote_gauche != null ? String(r.photo_cote_gauche) : null,
    photoCoteDroit: r.photo_cote_droit != null ? String(r.photo_cote_droit) : null,
